...
function About_Event() {
  ...
  return (
    <div
      className="bg-transparent text-white/95 bg-cover bg-top flex justify-item-center"
      style={{
        backgroundImage:
          "url('https://img.freepik.com/premium-photo/planet-earth-isolated-black_41050-3269.jpg?w=1060')",
      }}
    >
      <div
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 flex">
          {data.map(function (e) {
            return (
              <div
                style={{
          ...
          >
            <div className="flex flex-col items-center pb-10 mt-10">
              <div className="bg-white rounded-full shadow-lg p-2 w-20 h-20">
                <img src={ui} alt="" className="mb-3" />
              </div>
              <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">
                UI/UX Design
              </h5>
              ...
              <div className="flex mt-4 space-x-3 md:mt-6">
                <p className="px-4 text-center">
                  ...
                  obcaecati laboriosam? Sed est beatae veniam id! Amet, esse
                  molestiae voluptatem, obcaecati veniam distinctio minima
                  quaerat nobis hic perferendis sunt dolorum.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center pb-10 mt-10">
              <div className="bg-white rounded-full shadow-lg p-2 w-20 h-20">
                <img src={social} alt="" className="mb-3" />
              </div>
              <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">
          ...
          >
            <div className="flex flex-col items-center pb-10 mt-10">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-browser-chrome w-20 h-20 mb-3 rounded-full shadow-lg"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
